...
ActiveRecord::Schema.define(version: 20_180_410_153_546) do
  ...
  create_table 'int_points', id: :serial, force: :cascade do |t|
    ...
    t.index %w[lat lng], name: 'index_int_points_on_lat_and_lng', where: '((lat IS NOT NULL) AND (lng IS NOT NULL))'
    t.index %w[source_type source_id], name: 'index_int_points_on_source_type_and_source_id'
